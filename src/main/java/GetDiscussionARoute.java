...
public class GetDiscussionARoute implements Route{

    private static final Logger LOGGER = Logger.getLogger(GetDiscussionARoute.class.getName());

    private final Configuration conf;
    private UserManager manager;

    public GetDiscussionARoute(UserManager manager, Configuration conf){
        this.conf = conf;
    ...
    public Object handle(Request request, Response response) {
        ...
        try {
            ...
            Template template = conf.getTemplate("discussionA.ftl");
