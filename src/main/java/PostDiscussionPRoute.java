...
public class PostDiscussionPRoute implements Route {

    private static final Logger LOGGER = Logger.getLogger(PostDiscussionPRoute.class.getName());

    private UserManager manager;

    public PostDiscussionPRoute(UserManager manager, TemplateEngine engine) {
