...
public class PostDiscussionLRoute implements Route {

    private static final Logger LOGGER = Logger.getLogger(PostDiscussionLRoute.class.getName());

    private UserManager manager;

    public PostDiscussionLRoute(UserManager manager, TemplateEngine engine) {
    ...
    public Object handle(Request request, Response response) {
        ...
        response.redirect(WebServer.DISCUSSIONL, HttpURLConnection.HTTP_MOVED_PERM);
